...
import CanvasBg from './components/DashboardDrag/CanvasBg.vue';
import CanvasThumbnail from './components/DashboardDrag/CanvasThumbnail.vue';
import CanvasSlider from './components/DashboardDrag/CanvasSlider.vue';
