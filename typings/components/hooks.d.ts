...
export declare function initParent(
  containerRef: Ref<HTMLElement | undefined>
): {
  parentWidth: Ref<number>;
  parentHeight: Ref<number>;
};
export declare function initLimitSizeAndMethods(
  props: any,
...
export declare function initDraggableContainer(
  containerRef: Ref<HTMLElement | undefined>,
  containerProps: ReturnType<typeof initState>,
  ...
  parentSize: ReturnType<typeof initParent>,
  OFFSET: any // 添加 OFFSET 参数
): {
  containerRef: Ref<HTMLElement>;
};
export declare function initResizeHandle(
  containerProps: ReturnType<typeof initState>,
  limitProps: ReturnType<typeof initLimitSizeAndMethods>,
  parentSize: ReturnType<typeof initParent>,
  props: any,
...
export declare function watchProps(
  props: any,
